    ...
    timedAction(function (index) {
      ...
      switch (action) {
        ...
        case "bscd":
          ...
          timedAction(function (index) {
            console.log("bslog:",index)
            var weses = new Date().getTime()/1000 - 1639238640;
            var bsaday = 86400;
            var bsahour = 3600;
            var realday = parseInt(weses/bsaday)
            var realhour = parseInt((weses-bsaday*realday)/bsahour)
            
            var realMinSes = weses - parseInt(weses/bsahour)*bsahour
            var realmin = parseInt(realMinSes/60)
            var realSes = parseInt(realMinSes -  60*realmin);
            ...
            if (index==30000){
              ...
              say = realmin + "分" + realSes + "秒"
            }
            console.log("bssay:",say)
            S.Shape.switchShape(S.ShapeBuilder.letter(say), true);
          }, 2000, value, true);
          break;
        case 'countdown':
          value = parseInt(value) || 10;
